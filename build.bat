...
REM Notes:
set CommonCompilerFlags=-I..\src\vendor -I..\src\include
...
REM Debug Build
cl %CommonCompilerFlags% -Z7 "..\src\cpp\winMain.cpp" "..\src\cpp\jade\platform\windows\Window.cpp" %CommonLinkerFlags%
popd
